...
My talk focuses on surveying common data formats and unified solutions for code coupling between HPC and AI and the schema requirements for such workflows.
Schemas in addition to self described data give the developer the ability to confine the domain of the file contents and protect data integrity by providing checks for writing data outside the input domain.
