...
Because AI training rarely requires every byte of a dataset, the tutorial presents methods and tools for selective data access at user-defined accuracy levels, covering self-describing file formats (ADIOS and HDF5), derived variables and queries, campaign management for centralizing metadata, and replication campaigns for resilient access across storage tiers. Applications from diverse scientific domains (e.g., fusion, combustion, and experimental data) demonstrate how this organizational framework transforms datasets into assets for domain-aware AI model training.
