---
permalink: /talks/2026-03-17-scheduling
layout: talk
title: "Dynamic Resource Allocation for Reasoning Agents in HPC Workflows"
author_profile: true
toc: false
classes: wide
collection: talks
type: "Invited Talk"
venue: "19th Scheduling for large-scale systems workshop"
date: 2026-03-17
...
<br/>
I discuss the scheduling challenges inherent in this "stochastic" workflow, presenting preliminary results to address the need for a trade-off between token consumption and computation and for priority based scheduling for agentic tasks, with real examples from the nuclear energy community.
...
<br/>
Link to my talk: [PDF](https://graal.ens-lyon.fr/~yrobert/slides-frejus/Gainaru.pdf)
